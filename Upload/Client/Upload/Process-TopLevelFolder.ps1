...
#$folderName = "I:\MFDs (same extensions)\AWP\Non-AWP employed staff\11_07_2016\cc8e832a-0d04-4fd0-ab98-3df627591233"
#$folderName = "I:\01.01.2018-31.12.2018\AWP\General\02_11_2018\6ff2ad3a-f038-4708-8351-e0f138ec5d57"
$folderName = "C:\temp\TestDupes"
...
if ( $folderName -eq $null ) {
    ...
    Process-Folder -FolderFullPath "$Drive\\$global:topLevelFolderName\AWP" -logName $logName -runType DRY_RUN #NOTE RUN TYPE over-ridden in Process-Folder function
} else {
    Process-Folder -FolderFullPath $folderName -logName $logName -runType DRY_RUN #NOTE RUN TYPE over-ridden in Process-Folder function
}
